...
ENT.PrintName = "Gas Pump" -- The name that will appear in the spawn menu.
ENT.Author = "Ramsay" -- The author's name for this Entity.
ENT.Category = "Ramsay" -- The category for this Entity in the spawn menu.
ENT.Contact = "" -- The contact details for the author of this Entity.
ENT.Purpose = "Refuel Glide vehicles." -- The purpose of this Entity.
